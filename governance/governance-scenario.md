...
>> What prompted them to solve the problem?  This
>> What was the benefits of implementing the solution described blow?

This sample scenario is applicable to any new or existing Azure environment, to ensure it meets the minimum governance requirements expected by the organization. 
